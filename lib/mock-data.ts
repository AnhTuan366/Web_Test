...
// Ngoại lệ: hội thoại chatbot (chat_conversations/chat_messages) đã nối Supabase thật,
// không còn mock trong file này — xem app/api/chat/route.ts và lib/supabase-admin.ts.
